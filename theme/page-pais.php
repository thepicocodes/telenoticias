...
<div
  ...
  <div class="order-2 w-full max-w-5xl">
    ...
    <section class="">
      <div class="mt-10 grid lg:grid-cols-[1fr_300px] gap-x-5">
        <div>
          <div class="section-item all grid md:grid-cols-2 mb-10 gap-y-6 gap-x-5 lg:justify-start">
            ...
            <div class="mt-4 md:mt-0 grid gap-x-2 gap-y-4">
              <a href="/">
                <article
                  class="rounded-md border w-full grid grid-cols-[1fr_120px] overflow-hidden min-h-[140px] max-h-[140px]">
                  <p class="w-full p-4 text-body-b text-blue-300">Son una forma emocionante de poner a prueba el cuerpo
                    y la mente</p>
    ...
    <section class="mt-8">
      <div class="grid md:grid-cols-2 lg:grid-cols-[1fr_1fr_300px] gap-x-8 gap-y-5">
        <div class="relative h-[300px]">
          <a href="#" class="relative block w-full h-full bg-white">
            <article class="relative w-full h-[300px] bg-gradient-to-t from-overlay-100 to-overlay-0">
              <img src="<?php echo get_template_directory_uri(); ?>/images/img-01.png" alt=""
    ...
    <section class="mx-auto mt-8 max-w-[960px]">
      <div class="mt-6 grid gap-x-8 gap-y-5 md:grid-cols-2 lg:grid-cols-3">
