...
<div class="w-full max-w-[1350px] grid grid-cols-1 xl:grid-cols-[160px_1fr_160px] gap-y-5 gap-x-5 justify-items-center mt-8 mx-auto px-5">
  ...
  <div class="order-2 w-full max-w-5xl">
    ...
    <section class="mt-8">
      <div class="mt-10 grid grid-cols-1 gap-y-8 md:grid-cols-[1fr_320px] gap-x-8">
          ...
          <a href="">
            <article class="grid h-max w-full lg:h-[250px] lg:grid-cols-[300px_1fr]">
              ...
              <div class="flex w-full flex-col justify-between rounded-bl-lg rounded-br-lg border px-2 py-4 lg:rounded-bl-none lg:rounded-br-lg lg:rounded-tr-lg lg:px-4">
                <p class="text-body-b lg:text-m-b text-blueLight-900 mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</p>
          ...
          <a href="">
            <article class="grid w-full lg:h-[250px] lg:grid-cols-[1fr_300px]">
              <div class="order-2 flex w-full flex-col justify-between rounded-bl-lg rounded-br-lg border px-2 py-4 lg:order-1 lg:rounded-bl-lg lg:rounded-br-none lg:rounded-tl-lg lg:rounded-tr-none lg:px-4">
                <p class="mt text-body-b lg:text-m-b text-bluelight-900 mt-2">lorem ipsum dolor sit amet, consectetur adipiscing elit...</p>
        ...
        <div class="flex flex-col items-center">
          <div class="w-[320px] h-[300px] rounded-md bg-[#F1F3F7] p-4">
            <div class="h-full w-full bg-[#D6CCFF]"></div>
          </div>
          <div class="w-[320px] mt-5 h-[300px]  rounded-md bg-[#F1F3F7] p-4">
            <div class="h-full w-full bg-[#D6CCFF]"></div>
          </div>

          <div id="lotery-swiper" class="swiper w-full mt-8">
            <h3 class="lg:text-h5 text-blue-300 text-lg">Lotería</h3>
                  ...
                  <div>
                    <div class="mt-4 flex flex-col gap-x-2 border-b border-[#E8E8E8] pb-4">
                      ...
                      <div class="mt-1.5 flex flex-row items-center gap-x-2.5">
                        <span class="text-body-b flex h-[30px] w-[30px] items-center justify-center rounded-full bg-blue-300 text-lightBlue-100">01</span>
                        <span class="text-body-b flex h-[30px] w-[30px] items-center justify-center rounded-full bg-blue-300 text-lightBlue-100">01</span>
                        <span class="text-body-b flex h-[30px] w-[30px] items-center justify-center rounded-full bg-blue-300 text-lightBlue-100">01</span>
                      </div>
                    </div>
                    ...
                    <div class="mt-4 flex flex-col gap-x-2 border-b border-[#E8E8E8] pb-4">
                      <h5 class="text-body-b text-blue-100">Super Kino TV</h5>
    ...
    <section>
      <div class="mt-8 grid grid-cols-1 md:grid-cols-[1fr_300px] gap-x-8 gap-y-5">
        <a href="#" class="relative block w-full bg-white">
        ...
        <div class="flex flex-col">
          ...
          <div class="mt-8">
            <h3 class="text-m-b text-blue-300">Siguenos</h3>
            <ul class="mt-2 flex flex-wrap items-center gap-8">
              <li>
                <a href="" class="">
                  <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-300 h-8" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
              ...
              <li>
                <a href="">
                  <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-300 h-8" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
              ...
              <li>
                <a href="">
                  <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-300 h-8" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
              ...
              <li>
                <a href="">
                  <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-300 h-8" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
