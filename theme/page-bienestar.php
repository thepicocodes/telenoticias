      ...
      <div class="mt-10 grid grid-cols-1 gap-y-8 md:grid-cols-[1fr_320px] gap-x-8">
        ...
        <div class="flex flex-col items-center">
                  ...
                  <div>
                    <div class="mt-4 flex flex-col gap-x-2 border-b border-[#E8E8E8] pb-4">
                      ...
                      <div class="mt-1.5 flex flex-row items-center gap-x-2.5">
                        <span
                          class="text-body-b flex h-[30px] w-[30px] items-center justify-center rounded-full bg-blue-300 text-lightBlue-100">01</span>
                        <span
                          class="text-body-b flex h-[30px] w-[30px] items-center justify-center rounded-full bg-blue-300 text-lightBlue-100">01</span>
                        <span
                          class="text-body-b flex h-[30px] w-[30px] items-center justify-center rounded-full bg-blue-300 text-lightBlue-100">01</span>
          ...
          <div class="mt-6 flex w-full justify-center">
            <div
              class="swiper-pagination-fraction swiper-pagination-horizontal flex !w-[114px] flex-row items-center justify-center rounded-2xl bg-[#F1F1F1] px-2 py-1">
